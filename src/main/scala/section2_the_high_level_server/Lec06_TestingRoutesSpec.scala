...
object Lec06_TestingRoutesSpec extends BookJsonProtocol with SprayJsonSupport {
...
class Lec06_TestingRoutesSpec
  extends WordSpec with Matchers with ScalatestRouteTest with BookJsonProtocol {

  import Lec06_TestingRoutesSpec._
